# Inception Score was introduced by Tim Salimans, Ian Goodfellow, Wojciech Zaremba, Vicki Cheung, Alec Radford, and Xi Chen in "Improved Techniques for Training GANs", see https://arxiv.org/abs/1606.03498.
# The original implementation is by OpenAI. See https://github.com/openai/improved-gan.
# The PyTorch version is adapted by Anton Obukhov, licensed under the Apache License 2.0. See https://github.com/toshas/torch-fidelity/blob/master/torch_fidelity/metric_isc.py.
