# DPM-Solver and DPM-Solver++ was introduced by Cheng Lu, Yuhao Zhou, Fan Bao, Jianfei Chen, Chongxuan Li, and Jun Zhu in "DPM-Solver: A Fast ODE Solver for Diffusion Probabilistic Model Sampling in Around 10 Steps" and "DPM-Solver++: Fast Solver for Guided Sampling of Diffusion Probabilistic Models", see https://arxiv.org/abs/2206.00927 and https://arxiv.org/abs/2211.01095.
# The original implementation is by Cheng Lu, licensed under the MIT License. See https://github.com/LuChengTHU/dpm-solver.
# This implementation is by NVIDIA CORPORATION & AFFILIATES, licensed under the Apache License 2.0. See https://github.com/NVlabs/Sana/blob/main/diffusion/model/dpm_solver.py.
