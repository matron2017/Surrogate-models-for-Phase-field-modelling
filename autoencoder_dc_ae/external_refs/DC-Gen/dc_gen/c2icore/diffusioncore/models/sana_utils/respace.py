...
# This implementation is modified by NVIDIA CORPORATION & AFFILIATES, licensed under the Apache License 2.0. See https://github.com/NVlabs/Sana.
...
class _WrappedModel:
    ...
    def __call__(self, x, timestep, **kwargs):
        ...
        return self.model(x, t=new_ts, **kwargs)
