        ...
        with h5py.File(fout, mode) as h5f:
            ...
            for sim in sim_list:
                ...
                if 'images' in grp:
                    ...
                    grp['pairs_time'].resize((grp['pairs_time'].shape[0] + ptime.shape[0], 2)); grp['pairs_time'][-ptime.shape[0]:] = ptime
                ...
                if 'thermal_gradient_series' in grp:
                    ...
                    grp['thermal_gradient_series_norm'].resize((old + len(ts),)); grp['thermal_gradient_series_norm'][-len(ts):] = G_norm_val
                else:
