...
def main():
    ...
    ap.add_argument("--data-root", type=str,
        default="/scratch/project_2008261/pf_surrogate_modelling/data/deterministic")
    ap.add_argument("--split", type=str, default="train", choices=["train","val","test"])
    ap.add_argument("--pf-loader", type=str,
        default="/scratch/project_2008261/pf_surrogate_modelling/models/train/core/pf_dataloader.py")
