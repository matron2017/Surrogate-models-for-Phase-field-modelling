#!/bin/bash
# Flow-only best-checkpoint endpoint visuals on small CPU partition.

#SBATCH --job-name=small_flow_best_only
...
echo "[flow_best_only] device=${DEVICE}"
echo "[flow_best_only] scale_batch_size=${SCALE_BATCH_SIZE}"
