...
#SBATCH --job-name=ae_latent_gpu_4n16g_lola_big_adamw_latent32_rc_lr1e5
...
CFG=${ROOT}/configs/train/train_ae_latent_gpumedium_adamw_uncached_freq1_lola_big_64_1024_12g_latent32_nowavelet_b40.yaml
...
echo "=== Launching AE latent GPU (4 nodes x 4 GPUs, AdamW, rightclean fixed34, b40) ==="
