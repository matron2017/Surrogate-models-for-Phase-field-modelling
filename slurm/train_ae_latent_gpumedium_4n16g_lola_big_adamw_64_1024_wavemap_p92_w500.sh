#!/bin/bash
# AE latent gpu (4 nodes x 4 GPUs, LoLA big 64-1024, AdamW, wavelet map w500).

#SBATCH --job-name=ae_latent_gpu_4n16g_lola_big_adamw_64_1024_wavemap_p92_w500
...
CFG=${ROOT}/configs/train/train_ae_latent_gpumedium_adamw_lola_big_64_1024_12g_wavemap_p92_w500.yaml
...
echo "=== Launching AE latent gpu (4 nodes x 4 GPUs, LoLA big 64-1024, AdamW wavelet map w500) ==="
