#!/bin/bash
# AE latent gpu (4 nodes x 4 GPUs, LoLA big 64-1024, PSGD, wavelet map w500, 6-stage r32 1024/1024).

#SBATCH --job-name=ae_latent_gpu_4n16g_lola_big_psgd_f1_64_1024_wavemap_p92_w500_6stage_r32_1024
...
echo "=== Launching AE latent gpu (4 nodes x 4 GPUs, LoLA big 64-1024, PSGD wavelet map w500, 6-stage r32 1024/1024) ==="
