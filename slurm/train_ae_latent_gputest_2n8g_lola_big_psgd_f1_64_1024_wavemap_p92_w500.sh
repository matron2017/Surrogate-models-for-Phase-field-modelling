#!/bin/bash
# AE latent gputest (2 nodes x 4 GPUs, LoLA big 64-1024, PSGD, wavelet map w500).

#SBATCH --job-name=ae_latent_gputest_2n8g_lola_big_psgd_f1_64_1024_wavemap_p92_w500
...
echo "=== Launching AE latent gputest (2 nodes x 4 GPUs, LoLA big 64-1024, PSGD wavelet map w500) ==="
