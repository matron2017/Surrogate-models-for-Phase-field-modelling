#!/bin/bash
# AE latent gputest (2 nodes x 4 GPUs, LoLA big 64-1024, PSGD, wavelet map w500, 6-stage r32 1024/1024).

#SBATCH --job-name=ae_latent_gputest_2n8g_lola_big_psgd_f1_64_1024_wavemap_p92_w500_6stage_r32_1024
...
CFG=${ROOT}/configs/train/train_ae_latent_gpumedium_psgd_uncached_freq1_lola_big_64_1024_12g_wavemap_p92_w500_r32_6stage_1024.yaml
...
echo "=== Launching AE latent gputest (2 nodes x 4 GPUs, LoLA big 64-1024, PSGD wavelet map w500, 6-stage r32 1024/1024) ==="
