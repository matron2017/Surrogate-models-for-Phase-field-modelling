#!/bin/bash
#SBATCH --job-name=diffusion_unet_1pct_big_ddp8
...
CFG=${ROOT}/configs/train/train_diffusion_cosine_smoke_1pct_big.yaml
...
echo "=== Launching 8-GPU diffusion UNet 1% BIG (≈200M) ==="
