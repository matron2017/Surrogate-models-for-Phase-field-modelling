#!/bin/bash
#SBATCH --job-name=flowmatch_unet_1pct_ddp8
...
CFG=${ROOT}/configs/train/train_flowmatch_unet_smoke_1pct.yaml
...
echo "=== Launching 8-GPU flow-matching UNet 1% smoke (2 epochs) ==="
