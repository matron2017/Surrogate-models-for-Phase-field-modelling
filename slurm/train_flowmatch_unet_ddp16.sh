#!/bin/bash
#SBATCH --job-name=flowmatch_unet_ddp16
...
CFG=${ROOT}/configs/train/train_flowmatch_unet_full_16gpu.yaml
...
echo "=== Launching 16-GPU flow-matching UNet (4 nodes × 4 GPUs) ==="
