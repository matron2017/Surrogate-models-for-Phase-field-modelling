#!/bin/bash
#SBATCH --job-name=latent_unet_bridge12h_rdbm_prednext_afno8_b64_1n4g
...
CFG=${CFG:-${ROOT}/configs/train/train_diffusion_bridge_unet_thermal_latentpsgd_e279_gpu12h_1n4g_b64_rdbmres_predictnext_nomass_afno8.yaml}
