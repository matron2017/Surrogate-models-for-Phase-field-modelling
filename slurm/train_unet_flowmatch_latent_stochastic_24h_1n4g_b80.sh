...
#SBATCH --job-name=latent_unet_flowmatch24h_rdbm_afno8_b80_1n4g_sto
...
CFG=${CFG:-${ROOT}/configs/train/train_flowmatch_unet_thermal_latentpsgd_e279_gpu24h_1n4g_b80_rdbmres_afno8_stochastic.yaml}
RESUME=${RESUME:-}
