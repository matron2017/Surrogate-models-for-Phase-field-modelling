...
# Ensure repository root is on sys.path so 'datapipes' and 'models' are importable.
import sys, pathlib
ROOT = pathlib.Path(__file__).resolve().parents[1]  # .../tdxdsurrogate2
...
from datapipes.h5_dataset_solid import RSPairsDataset
...
def main() -> None:
    ...
    # Paths
    train_h5 = "/scratch/project_2008261/rapid_solidification/data/rapid_solidification/simulation_train.h5"
